...
namespace LevelGenerator
{
    ...
    public class Room
    {
        ...
        //Room's children
        [SerializeField] private Room leftChild = null;
        [SerializeField] private Room rightChild = null;
        [SerializeField] private Room bottomChild = null;

        [SerializeField] private int roomId; //Id of the node based on the sequential identifier
        ...
        [SerializeField] private Room parent = null;
